...
| --- | ------------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| 1   | [Border Radius Generator](tools/border-radius-generator.html) | Web & SEO | CSS border-radius playground. | [Try it](https://one-file-tools.pages.dev/tools/border-radius-generator.html) |
| 2   | [Open Graph Inspector](tools/open-graph-inspector.html) | Web & SEO | Analyze meta tags, social previews, and SEO metadata for any URL with actionable scores. | [Try it](https://one-file-tools.pages.dev/tools/open-graph-inspector.html) |
